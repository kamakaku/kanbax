...
// Import from queryClient instead of api-request to ensure parameter order consistency
...
export function CommentEditor({ taskId, onCommentAdded }: CommentEditorProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Use apiRequest with correct parameter order (method, url, data) from queryClient.ts
