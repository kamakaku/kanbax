...
export function CompanyInfoSection() {
  ...
  useEffect(() => {
    console.log("Dialog States:", { joinDialogOpen, createDialogOpen, inviteDialogOpen });
  }, [joinDialogOpen, createDialogOpen, inviteDialogOpen]);
  ...
  const joinCompanyMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      // Invalidiere alle relevanten Queries für sofortige Aktualisierung
  ...
  if (user && !isLoading && !company) {
    return (
        ...
        <CardFooter className="flex justify-center gap-4">
          <Button 
            ...
            onClick={() => {
              ...
              console.log("Setting joinDialogOpen to true");
          ...
          <Button 
            ...
            onClick={() => {
              ...
              console.log("Setting createDialogOpen to true");
      ...
      {/* Dialoge für Benutzer ohne Unternehmen */}
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="joinCode">Einladungscode</Label>
              <Input 
                id="joinCode"
                value={joinCode}
          ...
          <DialogFooter>
            ...
            >
              {joinCompanyMutation.isPending ? "Wird beigetreten..." : "Beitreten"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* Hinweis für normale Firmenmitarbeiter */}
              {user?.companyId && !user?.isCompanyAdmin && (
                <div className="mt-4 bg-blue-50 p-3 rounded-md border border-blue-100">
                  <p className="text-sm text-blue-700">
                    Als Firmenmitarbeiter können Sie die Unternehmensinformationen einsehen, aber keine Änderungen vornehmen.
                    Bitte kontaktieren Sie Ihren Firmenadministrator für Änderungen.
                  </p>
                </div>
              )}
            </div>
