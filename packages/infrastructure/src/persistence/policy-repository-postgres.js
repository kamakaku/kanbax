...
exports.PolicyContextRepositoryPostgres = void 0;
class PolicyContextRepositoryPostgres {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
...
exports.PolicyContextRepositoryPostgres = PolicyContextRepositoryPostgres;
