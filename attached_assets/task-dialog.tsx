      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Dialog open={!!selectedAttachment} onOpenChange={(open) => !open && setSelectedAttachment(null)}>
            <DialogContent className="max-w-4xl p-0 overflow-hidden rounded-lg" aria-describedby="attachment-viewer-description">
              <span id="attachment-viewer-description" className="sr-only">Vorschau des ausgewählten Anhangs</span>
      ...
      <DialogContent className="max-w-3xl p-0" aria-describedby="task-dialog-description">
        <div className="px-6 pt-6 pb-2">
          ...
          <p id="task-dialog-description" className="text-sm text-muted-foreground">
            {isEditMode ? (task ? "Bearbeiten Sie die Details der Aufgabe." : "Erstellen Sie eine neue Aufgabe.") : "Details der Aufgabe ansehen."}
          </p>
        </div>
